...
menu-delete-project = 删除 Evidence 项目…
menu-archive-project = 存档项目…
menu-restore-archive = 从存档恢复项目…
menu-import = 导入Evidence文献…
