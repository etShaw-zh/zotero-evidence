...
screen-queue-sidenav-tooltip =
    .tooltiptext = 标题/摘要筛选
screen-queue-no-criteria = 该项目还没有配置筛选标准，请先通过"文件 > 筛选标准 > 纳入/排除标准…"设置。
...
screen-queue-consistency-title = 人人一致性检查
screen-queue-consistency-reviewer-a = 筛选人员 A
screen-queue-consistency-reviewer-b = 筛选人员 B
screen-queue-consistency-reason = 排除理由：{ $reason }
