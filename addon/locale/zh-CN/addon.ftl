...
menu-human-consistency = 人-人筛选一致性…
dialog-human-consistency-title = 人-人筛选一致性
human-consistency-intro = 从当前队列中抽样一部分,分发给两名筛选人员,待双方各自完成后导入对比。
human-consistency-percent-label = 抽样比例（占队列的 %）
human-consistency-start-pilot-button = 开始抽样轮次
human-consistency-archive-save-title = 保存抽样存档为…
human-consistency-waiting-note = 抽样轮次进行中：已抽取 { $n } 篇文献。请将存档分发给两名筛选人员；拿到双方导出的筛选日志后，在下方导入对应的 CSV。
...
human-consistency-col-a = 筛选人员 A
human-consistency-col-b = 筛选人员 B
human-consistency-col-final = 最终决定
human-consistency-final-unset = （暂不确定）
human-consistency-apply-button = 应用并继续
human-consistency-pilot-done-note = 抽样轮次已完成协调。可以开始全量轮次，覆盖该队列中剩余（未抽样）的条目。
human-consistency-start-full-button = 开始全量轮次
human-consistency-full-done-note = 全量轮次已完成协调。你可以随时再开始新一轮抽样，重新检查一致性。
