...
ta-queue-run-ai = Run AI Judgment
ta-queue-rerun-ai = Re-run AI Judgment
ta-queue-loading = Working…
ta-queue-error-run-ai = AI judgment failed.
ta-queue-error-confirm = Failed to save the decision.
ta-queue-ai-suggestion = AI suggests:
ta-queue-consistency-title = Human-Human Consistency Check
ta-queue-consistency-reviewer-a = Reviewer A
ta-queue-consistency-reviewer-b = Reviewer B
ta-queue-consistency-reason = Reason: { $reason }
ta-queue-decided = Decided
ta-queue-confirmed = Decision saved.
ta-queue-untitled = (Untitled)
ta-queue-no-abstract = (No abstract available)
ta-queue-expand = Expand
ta-queue-collapse = Collapse
ta-queue-decision-include = Include
ta-queue-decision-exclude = Exclude
ta-queue-decision-unclear = Unclear
ta-queue-decision-unavailable = Unavailable

ta-queue-history-title = Screening record
ta-queue-history-none = No screening record found for this item.
ta-queue-history-ai = AI:
ta-queue-history-human = Human:
ta-queue-undo = Undo (back to TA-Screen Queue)
ta-queue-undo-done = Decision undone.
...
ft-queue-criterion-type-inclusion-short = I
ft-queue-criterion-type-exclusion-short = E
...
ft-queue-verdict-flip = Flip verdict
...
coding-generate-suggestions = Run AI Suggestions
coding-regenerate-suggestions = Re-run AI Suggestions
...
human-consistency-kappa-overall = Overall (final verdict)
human-consistency-kappa-ta = Title/Abstract (TA) stage
human-consistency-kappa-ft = Full-Text (FT) stage
...
human-consistency-recover-intro = Lost a round's own bookkeeping (e.g. after restoring this project from a backup)? If you still have the sample archive you sent reviewers and their returned CSVs, reconstruct the round from those instead of resampling. Choose the archive below, then each reviewer's CSV if you already have it (optional — you can add those later too).
human-consistency-recover-choose-archive-button = 1. Choose Sample Archive (.zip)…
human-consistency-recover-choose-csv-a-button = 2. Reviewer A's CSV (optional)…
human-consistency-recover-choose-csv-b-button = 3. Reviewer B's CSV (optional)…
human-consistency-recover-not-chosen = (not chosen)
human-consistency-recover-button = Recover Round
human-consistency-recover-need-archive = Choose the sample archive first
...
overview-sidenav-tooltip =
    .tooltiptext = Project Overview
overview-stage-sources-title = 1. Source Import
overview-stage-ta-title = 2. TA-Screening
overview-stage-ft-title = 3. FT Retrieval and Screening
overview-stage-final-title = 4. Final Studies
overview-stage-coding-title = 5. Extract Coding
overview-sources-unique = { $count } unique record(s)
overview-sources-breakdown = { $total } original, { $duplicates } duplicate(s) removed
overview-ta-pending = { $count } pending
overview-ta-breakdown = Include { $include } · Exclude { $exclude } · Unclear { $unclear }
overview-ft-retrieval = { $sought } sought for retrieval, { $notRetrieved } not retrieved
overview-ft-eligibility = Assessed { $assessed } · Pending { $pending } · Excluded { $excluded }
overview-final-count = { $count } final included study(ies)
overview-coding-progress = { $confirmed } / { $total } with confirmed evidence
config-warning-no-criteria = Screening criteria not set yet
config-warning-no-codebook = Codebook not imported yet
config-warning-set-criteria-button = Set Up
config-warning-import-codebook-button = Import Codebook
overview-button-enter = Enter
overview-button-view = View

ai-run-stage-reading = Reading full text…
ai-run-stage-analyzing = AI is analyzing the full text, please wait…
ai-run-stage-locating = Locating evidence ({ $current } / { $total })…
ai-run-stage-saving = Saving…
