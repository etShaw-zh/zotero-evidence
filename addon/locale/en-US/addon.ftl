...
dialog-consistency-stage-label = Stage
consistency-stage-ta = Title/Abstract Screening
consistency-stage-ft = Full-Text Screening
consistency-run-button = Compute Consistency
consistency-loading = Computing…
consistency-no-records = No comparable decisions yet for this stage (both an AI judgment and a human decision are required).
...
human-consistency-intro = Sample a subset of the queue, send it to two reviewers, and compare their independent decisions once both come back.
human-consistency-percent-label = Sample size (% of the queue)
human-consistency-start-pilot-button = Start Pilot Round
human-consistency-archive-save-title = Save Sample Archive As…
human-consistency-waiting-note = Pilot round in progress: { $n } item(s) sampled. Distribute the archive to two reviewers; once you have both of their exported screening logs, import the CSVs below.
...
human-consistency-col-a = Reviewer A
human-consistency-col-b = Reviewer B
human-consistency-col-final = Final Decision
human-consistency-final-unset = (leave pending)
human-consistency-apply-button = Apply & Continue
human-consistency-pilot-done-note = Pilot round reconciled. Start the full round to cover the remaining (not-yet-sampled) items in this queue.
human-consistency-start-full-button = Start Full Round
human-consistency-full-done-note = Full round reconciled. Start another pilot round any time to check consistency again.
