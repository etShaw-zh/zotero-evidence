// Ported near-verbatim from beaver-zotero's
// src/beaver-extract/worker/wasmHelpers.ts (AGPL-3.0, same license as this
// project -- see addon/content/lib/mupdf-LICENSE).
//
